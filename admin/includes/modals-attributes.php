     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 Jeste li sigurni da želite obrisati ovaj atribut?
             </div>
             <div class="modal-footer">
                 <?php $_SESSION['prevUrl'] = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
                 <button type="button" class="btn btn-secondary" data-dismiss="modal">Odustani</button>
                 <a href="attributes.php?delete=<?php echo $row['id'] ?>"><button type="button" class="btn btn-primary">Izbriši</button></a>
